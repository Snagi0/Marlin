...
#define CUSTOM_MACHINE_NAME "32Bit Ender"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Own autotune
  #define DEFAULT_bedKp 228.88
  #define DEFAULT_bedKi 41.7
  #define DEFAULT_bedKd 314.09
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1280, 1280, 6400, 15710 } // { 80, 80, 400, 450 } with 16 microseps
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 300, 50, 36 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 1100 }   //{ 500, 500, 100, 5000 } //e10500

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 1000, 1000, 200, 2200 } // ...or, set your own edit limits
#endif
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 10, 10, 1, 1 } // ...or, set your own edit limits
  #endif
#endif
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.065 // old 0.01 (mm) Distance from real junction edge
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, 3, -2.0 }
// X offset: -left  +right  [of the nozzle]
// Y offset: -front +behind [the nozzle]
// Z offset: -below +above  [the nozzle], smaller negative value: prints higher
...
#define LCD_BED_LEVELING
  ...
  #define LCD_PROBE_Z_RANGE 0.3     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 105.90 // old 113.26
  #define XY_DIAG_BD 105.84 // old 112.65
  #define XY_SIDE_AD 74.76  // old 79.88
  // measured AB 74.94         old 79.86
  // calculated AB 74,96265870           old 79.86307438

  // Or, set the default skew factors directly here
  // to override the above measurements:
  #define XY_SKEW_FACTOR  0.00056673   // old 0.00540042

  #define SKEW_CORRECTION_FOR_Z
  #if ENABLED(SKEW_CORRECTION_FOR_Z)
    #define XZ_DIAG_AC 105.60 // old 113.34
    #define XZ_DIAG_BD 106.08 // old 112.42
    #define XZ_SIDE_AD 75.00 // old 79.82
    // measured AB 74.4 // old 79.82
    // calculated AB  74,93951827 // old 79.81775241
    #define YZ_DIAG_AC 105.98 // old 112.99
    #define YZ_DIAG_BD 105.94 // old 113.04
    #define YZ_SIDE_AD 75.16 // old 79.91
