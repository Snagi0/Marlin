...
#define EXTRUDER_RUNOUT_PREVENT
  ...
  #define EXTRUDER_RUNOUT_SPEED 600  // (mm/m)
 ...
 */
  ...
  #define FAST_PWM_FAN_FREQUENCY 35000
...
#define HOMING_BUMP_DIVISOR { 12, 12, 15 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  35, 68 }, { 113,  41 }, { 94, 139 } }

  // Define positions names for probing points.
  #define TRAMMING_POINT_NAME_1 "Left"
...
#define LCD_SHOW_E_TOTAL
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN      P2_12 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MINIMUM_STEPPER_PULSE 1 //50 helps extruder noice with lin advance but causes under extrusion at higher speeds
